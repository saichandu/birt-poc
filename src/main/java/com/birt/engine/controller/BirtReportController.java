package com.birt.engine.controller;

import com.birt.engine.dto.OutputType;
import com.birt.engine.dto.Report;
import com.birt.engine.service.BirtReportService;
...
public class BirtReportController {
    ...
    @RequestMapping(produces = "application/json", method = RequestMethod.GET, value = "/reports")
    @ResponseBody
